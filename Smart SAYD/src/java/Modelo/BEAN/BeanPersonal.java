...
public class BeanPersonal {
    ...
    public void setPais_Expedicion(String Pais_Expedicion) {
        this.Pais_Expedicion = Pais_Expedicion;
    }
    ...
    public String getRH_y_Gruposanguineo() {
        return RH_y_Gruposanguineo;
    }

    public void setRH_y_Gruposanguineo(String RH_y_Gruposanguineo) {
        this.RH_y_Gruposanguineo = RH_y_Gruposanguineo;
    }
